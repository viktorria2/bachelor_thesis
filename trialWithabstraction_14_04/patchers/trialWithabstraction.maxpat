...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2400.0, 168.0, 145.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 945.0, -4.0, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2400.0, 124.0, 154.0, 31.0 ],
					"text" : "Start Playing",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2341.0, 1286.0, 2121.0, 36.0 ],
					"text" : "script newobject comment @text Beat @patching_rect $2 205 40 20, script newobject comment @text Bar @patching_rect $3 235 40 20, script newobject comment @text Tempo @patching_rect $4 265 40 20, script newobject comment @text OriginalTempo @patching_rect $5 235 100 20, script newobject comment @text TimeSignature @patching_rect $6 210 100 20, script newobject comment @text NewTempo @patching_rect $5 113 60 20, script newobject comment @text Press_to_choose_MIDI_file @patching_rect $2 45 150 20, script newobject comment @text Press_to_set_Time_Signature @patching_rect $6 45 150 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 3378.0, 457.0, 39.0, 22.0 ],
					"text" : "+ 235"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3337.0, 566.0, 38.0, 20.0 ],
					"text" : "X6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4055.0, 352.0, 48.0, 22.0 ],
					"text" : "pipe 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3238.0, 566.0, 38.0, 20.0 ],
					"text" : "X5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 3242.0, 453.0, 39.0, 22.0 ],
					"text" : "+ 215"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4201.0, 741.0, 58.0, 22.0 ],
					"text" : "set $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4085.0, 598.0, 58.0, 22.0 ],
					"text" : "pak 0 5 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3812.0, 339.0, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3924.0, 468.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3842.0, 236.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3960.0, 297.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4201.0, 824.0, 50.0, 22.0 ],
					"text" : "3 8"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4136.0, 741.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4121.0, 805.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4060.0, 805.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "bang", "" ],
					"patching_rect" : [ 3911.0, 389.0, 40.0, 22.0 ],
					"text" : "seq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4055.0, 444.0, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 4060.0, 683.0, 175.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4055.0, 399.0, 40.0, 22.0 ],
					"text" : "pak i i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4107.0, 345.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4055.0, 321.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4055.0, 193.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4055.0, 236.0, 80.0, 22.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 4055.0, 158.0, 67.0, 22.0 ],
					"text" : "opendialog"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 4055.0, 118.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3288.0, 16.5, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 3149.0, 136.5, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 3208.0, 16.5, 30.0, 22.0 ],
					"text" : "* 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3149.0, 56.5, 46.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3149.0, 93.5, 633.0, 22.0 ],
					"text" : "script newobject textbutton @varname $1moduleNumberToClear @text $1_Midi_clear @patching_rect 2850 $2 80 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2769.0, 242.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2769.0, 167.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2769.0, 114.0, 138.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2590.0, 89.0, 138.0, 27.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2646.0, 412.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 3077.0, 453.0, 39.0, 22.0 ],
					"text" : "+ 170"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3098.0, 566.0, 38.0, 20.0 ],
					"text" : "X4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "" ],
					"patching_rect" : [ 4055.0, 278.0, 88.0, 22.0 ],
					"text" : "mxj MidiParser"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2968.0, 652.0, 1514.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2745.0, 961.0, 1736.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2537.0, 914.0, 48.0, 22.0 ],
					"text" : "pipe 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 771.0, 112.0, 81.0, 22.0 ],
					"text" : "s startPlaying"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2723.0, 806.0, 150.0, 20.0 ],
					"text" : "connections"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2769.0, 749.0, 150.0, 20.0 ],
					"text" : "buttons "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2376.0, 712.0, 116.0, 34.0 ],
					"text" : "vlozit abstrakce s transportem uvnitr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2461.0, 846.0, 2012.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2461.0, 794.0, 55.0, 22.0 ],
					"text" : "pipe 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2395.0, 611.0, 46.0, 22.0 ],
					"text" : "pack i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2331.0, 761.0, 405.0, 22.0 ],
					"text" : "msg $1midimoduleAsAbstraction midimoduleAsAbstraction.maxpat $2 130"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2331.0, 804.0, 92.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 2960.0, 457.0, 39.0, 22.0 ],
					"text" : "+ 130"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 2880.0, 478.0, 32.0, 22.0 ],
					"text" : "+ 90"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 2782.0, 450.0, 32.0, 22.0 ],
					"text" : "+ 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2946.0, 566.0, 53.0, 20.0 ],
					"text" : "X3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2788.0, 566.0, 53.0, 20.0 ],
					"text" : "X2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2639.0, 566.0, 53.0, 20.0 ],
					"text" : "X1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 2783.0, 408.0, 37.0, 22.0 ],
					"text" : "* 300"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2745.0, 339.5, 239.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2745.0, 304.5, 239.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2537.0, 588.0, 856.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2350.0, 431.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2990.0, 1027.0, 1494.0, 91.0 ],
					"text" : "script newobject textbutton @varname $1readAMidiButton @text $1_extraMidi_read @patching_rect $2 67 100 20, script newobject number @varname $1bars @patching_rect $2 180 40 20, script newobject number @varname $1beats @patching_rect $3 210 40 20, script newobject number @varname $1tempo @patching_rect $4 240 40 20, script newobject number @varname $1barToFind @patching_rect $2 290 40 20 @hint \"Set Bar\" @bgcolor 0.392 0.286 0.537 1., script newobject number @varname $1beatToFind @patching_rect $4 290 40 20 @hint \"Set Beat\" @bgcolor 0.392 0.286 0.537 1., script newobject textbutton @varname $1leadOrPassive @text $1_passive @texton $1_lead @mode 1 @patching_rect $2 350 70 40, script newobject textbutton @varname $1setTimeSig @text $1_setTimeSig @patching_rect $6 67 130 20, script newobject message @varname $1timeSignature @patching_rect $6 190 100 20 @bgcolor 0.557 0.29 0.29 0.8, script newobject toggle @varname $1overrideToggle @patching_rect $2 400 20 20, script newobject number @varname $1originalSeqTempo @patching_rect $5 210 40 20, script newobject flonum @varname $1newTempo @patching_rect $5 89 40 20, script newobject flonum @varname $1koef @patching_rect $2 550 40 20 @bgcolor 0.557 0.29 0.29 0.8 @hidden 1, script newobject textbutton @varname $1runningOrStopped @text $1_stopped @texton $1_running @mode 1 @patching_rect $7 160 70 20, script newobject textbutton @varname $1muteUnmute @text $1_MUTE @texton $1_UNMUTE @mode 1 @patching_rect $7 95 90 20 @bgcolor 0.557 0.29 0.29 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2723.0, 1167.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 2590.0, 324.0, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 2590.0, 276.0, 24.0, 24.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 496.0, 531.0, 106.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 623.0, 602.0, 112.0, 30.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 496.0, 662.0, 1005.0, 521.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 645.0, 150.0, 144.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 496.0, 572.0, 24.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 311.0, 631.0, 145.0, 22.0 ],
									"saved_object_attributes" : 									{
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 485.0, 38.0, 97.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 533.0, 10.0, 194.0, 20.0 ],
...
, 							{
								"box" : 								{
									"bgcolor" : [ 0.631372549019608, 0.250980392156863, 0.250980392156863, 1.0 ],
									"hidden" : 1,
									"id" : "obj-31",
									"maxclass" : "newobj",
									"numinlets" : 0,
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 445.0, 9.0, 79.0, 22.0 ],
									"text" : "r startPlaying",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 263.0, 692.0, 97.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 263.0, 750.0, 67.0, 22.0 ],
									"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
									"text" : "thispatcher",
...
,
					"patching_rect" : [ 2419.0, 301.0, 83.0, 27.0 ],
					"text" : "p modules",
					"varname" : "modules"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3911.0, 339.0, 32.0, 22.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2630.0, 262.0, 35.0, 22.0 ],
					"text" : "set 0"
				}
