...
function bang(v) {
	...
	for (var i = 0; i < objects.length; i++) {
		...
		if (currentBars * 1000 + currentBeats >= Number(objects[i].targetBarsObj.getvalueof()) * 1000 + Number(objects[i].targetBeatsObj.getvalueof())) {
			if (Number(objects[i].newTempoObj.getvalueof()) != Number(objects[mainObj].origTempoObj.getvalueof())) {
			...
			if (Number(objects[i].newTempoObj.getvalueof()) != Number(objects[i].origTempoObj.getvalueof()) * Number(objects[i].koefObj.getvalueof())) {
				objects[i].newTempoObj.setvalueof(Number(objects[i].origTempoObj.getvalueof()) * Number(objects[i].koefObj.getvalueof()));
