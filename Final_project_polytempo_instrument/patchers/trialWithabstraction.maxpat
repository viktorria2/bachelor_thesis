...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2740.0, 37.0, 159.0, 22.0 ],
					"text" : "r clearThePlaygroundFromP"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2580.5, 37.0, 149.0, 22.0 ],
					"text" : "r createNewModuleFromP"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3069.0, 148.0, 221.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 1079.0, 805.0, 221.0, 47.0 ],
					"text" : "ALL DYNAMIC CREATED MODULES ARE HERE"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial Bold",
					"fontsize" : 20.0,
					"hint" : "Click to start playing all modules(fixed and dynamic)",
					"id" : "obj-137",
					"maxclass" : "textbutton",
					"numinlets" : 1,
					"numoutlets" : 3,
					...
					"presentation" : 1,
					"presentation_rect" : [ 1347.0, 786.0, 154.0, 31.0 ],
					"text" : "Start Playing",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 16.0,
					"hint" : "Click to clear the patch p modules",
					"id" : "obj-101",
					"maxclass" : "textbutton",
					"numinlets" : 1,
					"numoutlets" : 3,
					...
					"presentation" : 1,
					"presentation_rect" : [ 1345.0, 868.0, 159.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 16.0,
					"hint" : "Click to create a new module in the patch p modules",
					"id" : "obj-52",
					"maxclass" : "textbutton",
					"numinlets" : 1,
					"numoutlets" : 3,
					...
					"presentation" : 1,
					"presentation_rect" : [ 1348.0, 834.0, 153.0, 25.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 942.0, 32.0, 161.0, 22.0 ],
									"text" : "s clearThePlaygroundFromP",
									"varname" : "SENDclearThePlaygroundFromP"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 782.0, 32.0, 151.0, 22.0 ],
									"text" : "s createNewModuleFromP",
									"varname" : "SENDcreateNewModuleFromP"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 942.0, 0.0, 159.0, 27.0 ],
									"text" : "Clear the playground",
									"varname" : "copyClearThePlayground"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 782.0, 0.0, 151.0, 27.0 ],
									"text" : "Create new module",
									"usebgoncolor" : 1,
									"varname" : "copyCreateNewModule"
								}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 922.0, 807.0, 147.0, 43.0 ],
					"text" : "p modules",
					"varname" : "modules"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 2590.0, 75.0, 2577.0, 75.0, 2577.0, 129.0, 2590.0, 129.0 ],
					"source" : [ "obj-355", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 2749.5, 75.0, 2727.0, 75.0, 2727.0, 132.0, 2749.5, 132.0 ],
					"source" : [ "obj-357", 0 ]
				}
