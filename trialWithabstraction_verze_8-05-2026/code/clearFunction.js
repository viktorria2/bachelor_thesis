var keep = ["startPlaying", "toSave", "toSave[1]", "toSave[2]", "startTimeBang", "bangToCountNewTempo", "newTempoAlgorythmObject", "comments", "rModulesScript", "thispatcher[0]","graphAllModules","clearTheGraphButton","recieveBangToCompare","rStartPLAYING"]; //list of objects which should keep
